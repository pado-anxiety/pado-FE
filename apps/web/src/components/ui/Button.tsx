...
const BUTTON_TEXT_SIZE: Record<string, string> = {
  sm: 'text-label-small',
...
export function Button({
  ...
  const textSizeClass = BUTTON_TEXT_SIZE[size ?? 'default'];
        ...
        <>
          {isLoading ? (
            ...
            <span
              ...
              className={`${styles.label({ className: textClassName })} ${textSizeClass}`}
            >
              {text}
            </span>
          )}
