  ...
  return (
    ...
    >
      <div className="flex w-full flex-1 flex-col justify-between">
        ...
        <div
          className="flex w-full flex-col gap-4 pt-4 bg-btn-act-page-selected px-8"
          style={{ paddingBottom: insets?.bottom ?? 0 }}
        >
          {/* 프로그래스바 */}
          <div className="h-[10px] w-full overflow-hidden rounded-full bg-secondary">
            <motion.div
          ...
          <div className="flex w-full gap-3">
            {!isFirstStep ? (
              <Button
                ...
                onClick={handlePrev}
                className="flex-[0.3] border-2 border-solid border-btn-act-page bg-btn-act-page-selected"
              />
            ) : null}
            <Button
              size="default"
